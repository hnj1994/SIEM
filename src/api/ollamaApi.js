...
export async function explainAlert(alertJson) {
    const messages = [
        {
            role: 'user',
...
export async function generateIncidentSummary(incidentData) {
    const messages = [
        {
            role: 'user',
...
export async function translateToQuery(naturalLanguage) {
    const messages = [
        {
            role: 'user',
